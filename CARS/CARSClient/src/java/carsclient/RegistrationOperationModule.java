...
public class RegistrationOperationModule {
    ...
    public RegistrationOperationModule(AppointmentEntityControllerRemote appointmentEntityControllerRemote, PatientEntityControllerRemote patientEntityControllerRemote, DoctorEntityControllerRemote doctorEntityControllerRemote, ConsultationEntityControllerRemote consultationEntityControllerRemote) {
        this();
    ...
    private void registerWalkInConsultation() throws ParseException {
        ...
        Date today = new SimpleDateFormat("yyyy-MM-dd HH:mm").parse("2020-05-11 11:00");
        ...
        try {
            ...
            if(dayOfWeek == 5 && currentTime.after(new Time (sdf3.parse("16:30".trim()).getTime())) ) {
                ...
                try {
                    ...
                    System.out.println("Error parsing available consultation hours");
                }
                ...
                for(int i = 0; i < next6Slots.size(); i++) {
                    ...
                    for(int j = 0; j < doctors.size(); j++) {
                        doctorAvailability[i][j] = doctorEntityControllerRemote.doctorAvailableAtTime(doctors.get(j), next6Slots.get(i));
            ...
            System.out.println("Error parsing todays time");
        }
